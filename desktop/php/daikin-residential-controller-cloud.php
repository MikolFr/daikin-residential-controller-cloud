...
$plugin = plugin::byId('daikin-residential-controller-cloud');
...
<?php include_file('desktop', 'daikin-residential-controller-cloud', 'js', 'daikin-residential-controller-cloud');?>
